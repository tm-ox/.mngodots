...
async function main() {
  ...
  // 1a. Pinned bundle — self-contained build stored alongside this wrapper
  try {
    const bundlePath = join(__dirname, "hud-bundle.mjs");
  ...
  // 1b. OMC_PLUGIN_ROOT — highest priority (set by `omc --plugin-dir <path>`)
  try {
